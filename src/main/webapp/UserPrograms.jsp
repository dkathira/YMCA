...
<body>
	...
	<div class="innercontainer">
		<div class="sidebar">
			<a href="MemberLogin.jsp">Home</a> <a class="active"
				href="UserPrograms.jsp">Programs</a> <a href="Enrollments.jsp">Enrollments</a>
			<a href="UserProfile.jsp">Profile</a> <a href="Helppage.jsp">Help</a>
		</div>
		<div class="content">

			<div>

				<form class="example" action="UserProgramSearch.jsp"
					style="margin: auto; width: 300px">
					<input type="text" id="searchim" placeholder="Search.."
						name="searchim" style="width: 200px; height: 39px">
					<%
			...
			<div class="container">
				...
				<div class="row"
					...
					<div class="col-2 menu">
						<form method="post"
							action="RegisterServlet?PID=<%=resultset.getString("ProgramID")%>&UID=<%=Uname%>">
							<button type="submit" class="button1" value="Join" id="Join">Join</button>
						</form>

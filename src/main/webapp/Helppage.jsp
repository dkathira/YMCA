...
<body>
	...
	<div class="innercontainer">
		<div class="sidebar">
			...
			if (uniqID.endsWith("S")) {
			%>
			<a href="StaffLogin.jsp">Home</a> <a href="Programs.jsp">Programs</a>
			<a href="Members.jsp">Members</a> <a class="active"
				href="Helppage.jsp">Help</a>
			<%
			} else {
			%>
			<a href="MemberLogin.jsp">Home</a> <a href="Programs.jsp">Programs</a>
			<a class="active" href="Helppage.jsp">Help</a>
			<%
			}
			%>
		</div>
		...
		<div class="content">
			<embed src="docs/UserManual.pdf" type="application/pdf" width="100%"
				height="550px" />
		</div>
